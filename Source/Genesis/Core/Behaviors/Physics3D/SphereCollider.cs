...
{
    public class SphereCollider : PhysicsBehavior
    {
        ...
        public void CreateRigidBody(PhysicHandler handler, Vec3 offset, float radius, float mass)
        {
            ...
            RigidBodyConstructionInfo info = new RigidBodyConstructionInfo(mass, null, sphereShape, sphereShape.CalculateLocalInertia(mass));
