...
{
    public class Experimental : IRenderDevice
    {
        private mat4 p_mat;
        private mat4 v_mat;
        ...
        private void BuildRectShape()
        {
            ...
            shape.cbo = gl.GenBuffer(1);
            gl.BindBuffer(OpenGL.ArrayBuffer, shape.cbo);
            gl.BufferData(OpenGL.ArrayBuffer, colors.Length * sizeof(float), colors, OpenGL.DynamicDraw);
        ...
        public void DrawSprite(Sprite sprite)
        {
            ...
            mat4 mt_mat = mat4.Translate(sprite.Location.X, sprite.Location.Y, 0f);
            mat4 mr_mat = mat4.RotateZ(sprite.Rotation);
            mat4 ms_mat = mat4.Scale(sprite.Size.X, sprite.Size.Y, 0f);
        ...
        public void FillRect(Rect rect, Color color)
        {
            ...
            gl.UniformMatrix4fv(gl.GetUniformLocation(ShaderPrograms["MVPSolidShader"].ProgramID, "mvp"), 1, false, mvp.ToArray<float>());
            ...
            int colorBuffer = this.InstancedShapes["RectShape"].cbo;
            gl.EnableVertexAttribArray(1);
            gl.BindBuffer(OpenGL.ArrayBuffer, colorBuffer);
            gl.BufferData(OpenGL.ArrayBuffer, newColor.Length * sizeof(float), newColor, OpenGL.DynamicDraw);
            gl.VertexAttribPointer(1, 3, OpenGL.Float, false, 0, 0);
