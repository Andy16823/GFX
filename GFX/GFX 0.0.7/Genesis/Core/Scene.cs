...
namespace Genesis.Core
{
    ...
    public class Scene
    {
        ...
        /// </summary>
        public DiscreteDynamicsWorld CreatePhysics(float gravityX, float gravityY, float gravityZ)
        {
            ...
            this.PhysicsWorld.Gravity = new Vector3(gravityX, gravityY, gravityZ);
